...
ArgusCamera::ArgusCamera( std::shared_ptr < camera_context > ctx, const uint32_t width, const uint32_t height,
...
ArgusCamera::ArgusCamera( std::shared_ptr < camera_context > ctx, const po::variables_map &vm )
    :
    Camera(ctx),
